...
import 'package:tmdb/widgets/music_track_dialog.dart';
import 'package:video_player/video_player.dart';

class MusicTrackListViewTile extends StatelessWidget {
  const MusicTrackListViewTile({Key? key, required this.track})
      : super(key: key);
...
class _DetailedInfo extends StatelessWidget {
  ...
  var musicLibraryBloc = BlocProvider.of<MusicLibraryBloc>(context);
    ...
    return Container(
        ...
        child: InkWell(
          // onTap: () => musicLibraryBloc
          //     .add(MusicLibraryPlayEvent(filename: track.fileName!)),
          onTap: () => showDialog(
              context: context,
              builder: (BuildContext context) {
                return MusicTrackDialog(track: track,bloc:musicLibraryBloc);
              }),
          child: Card(
              elevation: 1.0,
