...
class BorrowedTrackDialog extends StatelessWidget {
  const BorrowedTrackDialog({Key? key, required this.track, required this.bloc})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
        ...
        content: _DetailedInfo(track: track, bloc: bloc));
  }
}

class _DetailedInfo extends StatelessWidget {
  const _DetailedInfo({Key? key, required this.track, required this.bloc})
      : super(key: key);
  final MusicTrack track;
  final MusicLibraryBloc bloc;
            ...
            AspectRatio(
              ...
              child: ClipRRect(
                  ...
                  child: InkWell(
                      onTap: () {
                        bloc.add(
                            MusicLibraryPlayEvent(filename: track.fileName!));
                ...
                child: Row(
                    ...
                    children: [
                      TextButton(
                        onPressed: () {
                          print("ReturnClick");
                          bloc.add(MusicLibraryReturnEvent(id: track.id!));
