...
class MusicTrackDialog extends StatelessWidget {
  const MusicTrackDialog({Key? key, required this.track, required this.bloc})
      : super(key: key);
                ...
                child: Row(
                    ...
                    children: [
                      TextButton(
                        onPressed: () {
                          print("BorrowClick");
                          bloc.add(MusicLibraryBorrowEvent(id: track.id!));
